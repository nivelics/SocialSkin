...
@Component({
  selector: 'app-biotor',
  templateUrl: './biotor.component.html',
  styleUrls: ['./biotor.component.scss']
})
export class BiotorComponent implements OnInit {
  ...
  video = "https://www.youtube.com/embed/cuzzo55nqO4";
