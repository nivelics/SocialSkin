...
@Component({
  selector: 'app-reduva',
  templateUrl: './reduva.component.html',
  styleUrls: ['./reduva.component.scss']
})
export class ReduvaComponent implements OnInit {
  ...
  video = "https://www.youtube.com/embed/ZG7FwqjwgEI";
